...
P1=normpdf(x,(xmax+xmin)/2,0.04*(xmax-xmin));
P2=normpdf(y,(ymax+ymin)/2,0.04*(ymax-ymin));
P0=P1'*P2;
...
%ylabel('v','FontSize',fsize)
%zlabel('p(x,v,t)','FontSize',fsize)
